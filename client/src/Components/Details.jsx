            ...
            <div className="row overflow-hidden bg-secondary">
              <div className="col bg-white">
                ...
                <img
                  ...
                  alt="imagen"
                  className="col-12 w-50 bg-white mx-auto d-block"
                />
              ...
              <div className="col col-5 pt-4">
                ...
                <div className="row d-flex justify-content-center mt-5 pt-4">
                  <button className="w-50 btn btn-outline-info fs-3">
                    ADD TO CART
                  </button>
                </div>
              </div>
            ...
            <div className="row text-center m-0 mt-5 grid gap-5">
              <a href="#" className="col">
                <img
                  ...
                  alt="foto"
                  className="w-75 border border-5 border-info shadow-lg rounded rounded-3"
                />
              </a>
              <a href="#" className="col">
                <img
