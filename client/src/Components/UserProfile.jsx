...
function UserProfile() {
  ...
  return (
    <div
      className="container p-0 bg-light shadow-lg con"
    ...
    >
      <div className="row w-100 mb-5">
        ...
        <div className="row align-items-center justify-content-center">
          <img
            src="https://previews.123rf.com/images/chudtsankov/chudtsankov1703/chudtsankov170300127/73952540-cara-divertida-de-dibujos-animados-feliz-con-expresi%C3%B3n-sonriente-ilustraci%C3%B3n-con-fondo-amarillo.jpg"
            alt="fondo"
      ...
      <div className="w-100">
        ...
        {orderUser.length > 0 ? (
          orderUser.map((order) => (
            <div
              className="row w-100 m-0 shadow-lg bg-light pt-5 p-2 p-md-4 mt-5 con"
              key={order.id}
            >
              <div className="shadow  datos">
                <h3 className="col-12 fw-bold text-center mb-2 pt-3">
                  Order data
                </h3>
                <div className="col-12 d-flex flex-column flex-xl-row gap-2 gap-xl-4 justify-content-center m-0 align-items-center pt-4 pb-4 rounded rounded-5">
                  ...
                  <p className="m-0">
                    <strong>Addres:</strong> {order.address}
                  </p>
                  <p className="m-0">
                    <strong>Phone Number:</strong> {order.telephoneNumber}{" "}
                  </p>
                  <p className="m-0">
                  ...
                  <p className="m-0">
                    <strong>Status:</strong> {order.delivered}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 mb-3 gap-5 cards">
                {order.shoppingCartItems.length > 0 ? (
                  order.shoppingCartItems.map((item) => (
                    <div
                      className="d-flex flex-column flex-md-row align-items-center gap-0 pt-3 pb-2 shadow pedido"
                      key={item.id}
                    >
                      ...
                      <div className="text-center text-md-start m-0 p-0 w-100">
                        ...
                        <p className="fs-5 m-0">
                          <strong>Price:</strong> ${item.product.finalPrice}
                        </p>
                        <p className="fs-5 m-0">
          ...
          <h1 className="text-center mt-5 pt-5 mb-5 pb-5 text-danger">
